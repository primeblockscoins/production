                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder=" "
                        className="peer w-full pt-5 pb-1 px-4 bg-cream border border-charcoal/10 rounded focus:border-gold focus:shadow-[0_0_12px_rgba(199,152,79,0.2)] focus:outline-none transition-all duration-300 text-sm font-sans"
                      />
                      <label
                        htmlFor="name"
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={handleChange}
                        className="peer w-full pt-5 pb-1 px-4 bg-cream border border-charcoal/10 rounded focus:border-gold focus:shadow-[0_0_12px_rgba(199,152,79,0.2)] focus:outline-none transition-all duration-300 text-sm font-sans appearance-none cursor-pointer"
                      >
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        onChange={handleChange}
                        placeholder=" "
                        className="peer w-full pt-5 pb-1 px-4 bg-cream border border-charcoal/10 rounded focus:border-gold focus:shadow-[0_0_12px_rgba(199,152,79,0.2)] focus:outline-none transition-all duration-300 text-sm font-sans resize-none"
                      />
                      <label
                        htmlFor="message"
                        className="absolute left-4 top-3 text-[10px] tracking-widest uppercase font-semibold text-charcoal-light/50 transition-all duration-300 pointer-events-none peer-focus:text-gold peer-focus:text-[8px] peer-focus:top-1.5 peer-[:not(:placeholder-shown)]:text-[8px] peer-[:not(:placeholder-shown)]:top-1.5"
                    ...
                    <button
                      type="submit"
                      className="btn-gold w-full mt-2 font-semibold tracking-[0.2em] shadow-sm hover:shadow-[0_4px_12px_rgba(199,152,79,0.2)] cursor-pointer"
                    >
                      Initiate Inquiry
                    </button>
                  </form>
